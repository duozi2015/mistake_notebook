...
export interface RegisterData { username: string; password: string; display_name?: string; invite_code?: string; role?: string }
...
export const authApi = {
  ...
  getRegistrationMode: () => api.get<{ mode: 'open' | 'invite_only' }>('/auth/registration-mode'),
}